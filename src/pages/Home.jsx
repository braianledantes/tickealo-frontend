  ...
  return (
    <div className="min-h-screen font-sans bg-[#05081b]">
      ...
      <section className="w-full max-w-7xl mx-auto px-6 py-12">
        <h2 className="text-2xl md:text-3xl font-semibold text-white mb-2 text-center">Clientes</h2>
        <p className="text-center text-white/70 max-w-2xl mx-auto mb-8">
          Descubrí eventos que se realizaron mediante nuestra ticketera QR.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">    
          <div className="relative rounded-xl overflow-hidden shadow-lg h-56">
            ...
            <div className="absolute inset-0 flex items-end p-6">
              <div className="flex items-center w-full gap-4">
                ...
                <div>
                  <div className="text-white font-semibold text-lg">Ruca Che</div>
                  <div className="text-sm text-white/80">Sede de grandes eventos deportivos y musicales, albergando desde partidos de alto nivel y competencias internacionales hasta recitales de reconocidos artistas.</div>
                </div>
          ...
          <div className="relative rounded-xl overflow-hidden shadow-lg h-56">
            <div
              className="absolute inset-0 bg-cover bg-center"
              style={{ backgroundImage: "url('https://imagenesyogonet.b-cdn.net/data/imagenes/2024/08/19/67020/1724070689-casino-magic-centenario-neuquen-02.jpg')" }}
              aria-hidden="true"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent" />
            <div className="absolute inset-0 flex items-end p-6">
              <div className="flex items-center w-full gap-4">
                ...
                <div>
                  <div className="text-white font-semibold text-lg">Casino Magic</div>
                  <div className="text-sm text-white/80">Presenta una agenda vibrante de espectáculos en vivo, que combina conciertos de artistas nacionales e internacionales, shows teatrales y propuestas culturales de primer nivel.</div>
                </div>
          ...
          <div className="relative rounded-xl overflow-hidden shadow-lg h-56">
            <div
              className="absolute inset-0 bg-cover bg-center"
              style={{ backgroundImage: "url('https://neuquenalinstante-s2.cdn.net.ar/st2i1700/2023/04/neuquenalinstante2/images/44/76/447622_c487de37ff1e252356c571f1b25a0e8d3dbaafc7a1f013ddd7ffc65f15b4ca00/sm.jpg')" }}
              aria-hidden="true"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent" />
            <div className="absolute inset-0 flex items-end p-6">
              <div className="flex items-center w-full gap-4">
                ...
                <div>
                  <div className="text-white font-semibold text-lg">Antares</div>
                  <div className="text-sm text-white/80">Antares Neuquén alberga Musiquita Experience, un ciclo de música eletrónica con talentos emergentes y consagrados.</div>
                </div>
          ...
          <div className="relative rounded-xl overflow-hidden shadow-lg h-56">
            <div
              className="absolute inset-0 bg-cover bg-center"
              style={{ backgroundImage: "url('https://framerusercontent.com/images/KFsyMKPw72LxNCbjJ3SdH5aU.png')" }}
              aria-hidden="true"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent" />
            <div className="absolute inset-0 flex items-end p-6">
              <div className="flex items-center w-full gap-4">
                ...
                <div>
                  <div className="text-white font-semibold text-lg">SportTech</div>
                  <div className="text-sm text-white/80">SportTech y Tikzet transformaron la Copa del Mundo de Taekwon-Do ITF “Mar del Plata 2024” con tecnología innovadora.</div>
                </div>
      ...
      {/* Footer */}
      <footer className="w-full mt-8 text-white" style={{ backgroundColor: '#03045E' }}>
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-sm">
            © {new Date().getFullYear()} Atomicos
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:opacity-80">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="text-white">
