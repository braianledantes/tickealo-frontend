  ...
  return (
    <div className="w-full relative">
      ...
      <textarea
        ...
        onBlur={handleBlur}
        className={`resize-none w-full min-h-[200px] p-4 pb-7 text-white rounded-lg bg-[#080C22] shadow-inner shadow-white/10 placeholder-gray-300 outline-none ${borderClass} selection:bg-blue-500/30 selection:text-white`}
      />
