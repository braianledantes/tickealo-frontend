...
export function HomeEventList({ eventos = [] }) {
  return (
    <div className="relative flex flex-col items-center justify-center pt-5 pb-10 z-10">
      ...
      <h2 className="animate-subtitle text-2xl md:text-3xl font-semibold tracking-wider text-white mb-5 text-center italic">
        NUESTROS PRÓXIMOS EVENTOS
      </h2>

      <p className="animate-subtitle text-center max-w-2xl mx-auto mb-10 text-white/70 tracking-wider">
